import{$ as e}from"./jquery-CEr4rF5i.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){c()});let r=1;const h=10;function T(t){const s=e("#tableSubmenu");if(s.empty(),t.length===0){s.append(`
            <tr>
