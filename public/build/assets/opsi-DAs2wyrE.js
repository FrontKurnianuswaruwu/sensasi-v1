import{$ as t}from"./jquery-CEr4rF5i.js";t.ajaxSetup({headers:{"X-CSRF-TOKEN":t('meta[name="csrf-token"]').attr("content")}});t(function(){u()});let r=1;const b=10;function T(e){const n=t("#tableSoal");if(n.empty(),e.length===0){n.append(`
            <tr>
