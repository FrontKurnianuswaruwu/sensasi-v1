import{$ as e}from"./jquery-BvxTx_lq.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){g()});let c=1;const v=10;function T(t){const s=e("#tableKategorisoal");if(s.empty(),t.length===0){s.append(`
            <tr>
