import{$ as i}from"./jquery-CEr4rF5i.js";i.ajaxSetup({headers:{"X-CSRF-TOKEN":i('meta[name="csrf-token"]').attr("content")}});i(function(){p()});let d=1;const h=10;function y(e){const t=i("#tableVisimisi");if(t.empty(),e.length===0){t.append(`
            <tr>
