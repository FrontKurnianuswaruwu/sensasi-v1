import{$ as e}from"./jquery-CEr4rF5i.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});let l=1;const y=10;function T(t){if(!t)return"-";const a=["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"],s=new Date(t);return isNaN(s)?"-":`${s.getDate()} ${a[s.getMonth()]} ${s.getFullYear()}`}function v(t){if(!t)return"";let s=t.toString().replace(/[^,\d]/g,"").split(","),n=s[0].length%3,i=s[0].substr(0,n),r=s[0].substr(n).match(/\d{3}/gi);return r&&(i+=(n?".":"")+r.join(".")),i=s[1]!==void 0?i+","+s[1]:i,"Rp "+i}function j(t){const a=e("#tableBody");if(a.empty(),t.length===0){a.append(`
            <tr>
