import{$ as e}from"./jquery-BvxTx_lq.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){p()});let l=1;const C=10;function T(t){const n=e("#tableArtikel");if(n.empty(),t.length===0){n.append(`
            <tr>
