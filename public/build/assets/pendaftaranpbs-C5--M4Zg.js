import{$ as t}from"./jquery-BvxTx_lq.js";t.ajaxSetup({headers:{"X-CSRF-TOKEN":t('meta[name="csrf-token"]').attr("content")}});let o=1;const x=10;function b(i){if(!i)return"-";const a=["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"],e=new Date(i);return isNaN(e)?"-":`${e.getDate()} ${a[e.getMonth()]} ${e.getFullYear()}`}function h(i){if(!i)return"";let e=i.toString().replace(/[^,\d]/g,"").split(","),n=e[0].length%3,s=e[0].substr(0,n),r=e[0].substr(n).match(/\d{3}/gi);return r&&(s+=(n?".":"")+r.join(".")),s=e[1]!==void 0?s+","+e[1]:s,"Rp "+s}function _(i){const a=t("#tableBody");if(a.empty(),i.length===0){a.append(`
            <tr>
