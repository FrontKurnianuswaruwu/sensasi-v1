import{$ as e}from"./jquery-CEr4rF5i.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){f()});let r=1;const b=10;function k(t){const o=e("#tableHerosection");if(o.empty(),t.length===0){o.append(`
            <tr>
