import{$ as e}from"./jquery-CEr4rF5i.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){u()});let d=1;const h=10;function T(t){const a=e("#tablePengurus");if(a.empty(),t.length===0){a.append(`
            <tr>
