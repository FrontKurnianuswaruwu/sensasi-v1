import{$ as e}from"./jquery-CEr4rF5i.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){u()});function v(t){if(!t)return"-";const a=["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"],i=new Date(t);return isNaN(i)?"-":`${i.getDate()} ${a[i.getMonth()]} ${i.getFullYear()}`}let l=1;const h=10;function T(t){const a=e("#tableBerita");if(a.empty(),t.length===0){a.append(`
            <tr>
