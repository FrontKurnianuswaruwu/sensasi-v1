import{$ as e}from"./jquery-CEr4rF5i.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){u()});function o(t){if(!t)return"";let a=t.toString().replace(/[^,\d]/g,"").split(","),n=a[0].length%3,r=a[0].substr(0,n),l=a[0].substr(n).match(/\d{3}/gi);return l&&(r+=(n?".":"")+l.join(".")),r=a[1]!==void 0?r+","+a[1]:r,"Rp "+r}let d=1;const b=10;function h(t){const s=e("#tablePengajuandana");if(s.empty(),t.length===0){s.append(`
            <tr>
