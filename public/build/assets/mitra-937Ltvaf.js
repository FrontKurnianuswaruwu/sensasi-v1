import{$ as e}from"./jquery-CEr4rF5i.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){u()});let l=1;const v=10;function C(t){const a=e("#tableMitra");if(a.empty(),t.length===0){a.append(`
            <tr>
