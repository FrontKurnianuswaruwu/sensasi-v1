import{$ as e}from"./jquery-CEr4rF5i.js";e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(function(){c()});let r=1;const b=10;function w(t){const n=e("#tableRole");if(n.empty(),t.length===0){n.append(`
            <tr>
