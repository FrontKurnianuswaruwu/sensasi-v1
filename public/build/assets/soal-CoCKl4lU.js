import{$ as t}from"./jquery-CEr4rF5i.js";t.ajaxSetup({headers:{"X-CSRF-TOKEN":t('meta[name="csrf-token"]').attr("content")}});let c=1;const b=10;let f=0;t(function(){p()});function p(e="",a=1){const i=t("#kategori_id").val();t.ajax({url:`/admin/getsoal/${i}`,type:"GET",data:{search:e,page:a,limit:b},dataType:"json",success:function(n){if(!Array.isArray(n.data))return;w(n.data,n.current_page),C(n.data),$(n.last_page,e),M(n.last_page,e);const s=(n.current_page-1)*b+1,o=s+n.data.length-1;t("#resultCount").html(`
