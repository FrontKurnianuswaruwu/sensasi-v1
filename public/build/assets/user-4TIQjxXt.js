import{$ as e}from"./jquery-CEr4rF5i.js";const x=e('meta[name="permission-edit-user"]').attr("content")==="1",v=e('meta[name="permission-delete-user"]').attr("content")==="1";tailwind.config={theme:{extend:{colors:{"orange-primary":"#FF6B35","orange-light":"#FF8A65","blue-primary":"#1E40AF","blue-light":"#3B82F6"}}}};e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});let r=1;const b=10;function I(t){const s=e("#tableBody");if(s.empty(),t.length===0){s.append(`
            <tr>
