import{$ as t}from"./jquery-BvxTx_lq.js";t.ajaxSetup({headers:{"X-CSRF-TOKEN":t('meta[name="csrf-token"]').attr("content")}});t(function(){u()});let r=1;const b=10;function T(e){const n=t("#tableSoal");if(n.empty(),e.length===0){n.append(`
            <tr>
        ...
        `);return}e.forEach((i,a)=>{let s=i.is_true==1||i.is_true===!0?'<span class="px-2 py-1 bg-green-100 text-green-800 text-xs font-semibold rounded-full">Benar</span>':'<span class="px-2 py-1 bg-red-100 text-red-800 text-xs font-semibold rounded-full">Salah</span>';const o=`
