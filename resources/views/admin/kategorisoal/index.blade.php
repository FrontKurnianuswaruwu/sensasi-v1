    ...
    <div class="p-4 lg:p-8">
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Kategori Soal</span>
                    </li>
        ...
        <div class="mb-6 flex justify-start fade-in" style="animation-delay: 0.2s;">
            <button id="addKategorisoalBtn" 
                ...
                <span>Tambah Kategori Soal</span>
            </button>
        </div>
...
@vite(['resources/css/user.css','resources/js/admin/kategorisoal.js'])
@endsection