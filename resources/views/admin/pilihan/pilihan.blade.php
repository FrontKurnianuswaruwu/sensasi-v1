...
<main class="flex-1 lg:ml-0 overflow-x-hidden">
    <div class="p-4 lg:p-8">
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <a href="{{ route('admin.pilihan.index') }}" class="text-blue-600 hover:underline">Data Soal {{ $pertanyaan }}</a>
                    </li>
                    <li><span class="mx-2">/</span></li>
                    <li>
                        <span class="text-gray-700">Data Pilihan</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <input type="hidden" id="soal_id" name="soal_id" value="{{ $idsoal }}">
            ...
            <div class="hidden lg:block">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody id="tableSoal" class="bg-white divide-gray-200">
...
<div id="pilihanModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-sm max-h-[90vh] overflow-y-auto">
            ...
            <!-- Body -->
            <form id="pilihanForm" class="p-6 space-y-6">
                <div class="space-y-2">
                    <input type="hidden" id="pilihanId" name="id">

                    <label for="pilihan" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-calendar-days mr-2 text-blue-primary"></i>Pilihan Soal
                    </label>

                    <input id="pilihan"
                            name="pilihan"
                            class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl 
                                    focus:border-blue-primary focus:ring-0 transition-all duration-300 
                                    text-gray-900 resize-none"
                            placeholder="Masukkan pilihan di sini...">
                </div>
                <div class="space-y-s">
                    <label for="status" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-toggle-on mr-2 text-blue-primary"></i>Status Pilihan
                    </label>
                    <select id="status" 
                            name="status"
                            class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl 
                                    focus:border-blue-primary focus:ring-0 transition-all duration-300 
                                    text-gray-900">
                        <option value="" disabled selected>Pilih status pilihan</option>
...
<div id="deleteModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <input type="hidden" id="deletepilihanId" name="id">
            ...
            <div class="p-6">
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-600">Data Soal <span id="deleteSoalsoalName" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                </div>
...
@vite(['resources/css/user.css','resources/js/admin/opsi.js'])
@endsection