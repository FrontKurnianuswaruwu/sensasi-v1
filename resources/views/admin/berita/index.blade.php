        ...
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Berita</span>
            ...
            <div class="hidden lg:block">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody id="tableBerita" class="bg-white divide-y divide-gray-200">
...
<div id="beritaModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="gradient-bg px-6 py-4 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 id="modalTitle" class="text-xl font-bold text-white">Tambah Berita Baru</h3>
                    </div>
            ...
            <!-- Body -->
            <form id="beritaForm" class="p-6 space-y-6">
                <input type="hidden" id="beritaId" name="id">
                
                <div class="space-y-2">
                    <label for="beritaJudul" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-tag mr-2 text-blue-primary"></i>Judul Berita
                    </label>
                    <input type="text" id="beritaJudul" name="beritaJudul" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan judul berita">
                </div>
                <!-- Row 2: Route & Icon -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="beritaKategori" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-list-alt mr-2 text-blue-primary"></i>Kategori
                        </label>
                        <select id="beritaKategori" name="beritaKategori" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900">
                    ...
                    <div class="space-y-2">
                        <label for="beritaTanggal" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-calendar-alt mr-2 text-blue-primary"></i>Tanggal & Waktu
                        </label>
                ...
                <div class="space-y-2">
                    <label for="beritaDeskripsi" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-align-left mr-2 text-blue-primary"></i>Deskripsi Berita
                    </label>
                    <input type="text" id="beritaDeskripsi" name="beritaDeskripsi" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan deskripsi berita">
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <input type="hidden" id="oldFoto" name="oldFoto">
                        <label for="beritaFoto" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-image mr-2 text-blue-primary"></i>Gambar Berita
                        </label>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden">
        <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <input type="hidden" id="deleteberitaId" name="id">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">Data Berita <span id="deleteBeritaName" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/berita.js'])
