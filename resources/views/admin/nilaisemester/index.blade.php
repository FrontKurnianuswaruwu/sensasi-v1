    ...
    <div class="p-4 lg:p-8">
        ...
        <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Nilai</span>
...
<div id="nilaiModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="gradient-bg px-6 py-4 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 id="modalTitle" class="text-xl font-bold text-white">Tambah Nilai Baru</h3>
                    </div>
            ...
            <!-- Body -->
            <form id="nilaiForm" class="p-6 space-y-6">
                <input type="hidden" id="nilaiId" name="id">
                <!-- Universitas -->
                <input type="hidden" name="mahasiswa_id" id="mahasiswa_id" value="{{ $mahasiswaid }}">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <select id="universitas" name="universitas"
                            class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-white focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-500" disabled>
                        </select>
                    </div>
                    <div class="space-y-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Tahun Akademik -->
                    <div class="space-y-2">
                        <label for="tahun_akademik_id" class="block text-sm font-semibold text-gray-600">
                    ...
                    <div class="space-y-2">
                        <label for="ip_semester" class="block text-sm font-semibold text-gray-600">
                            <i class="fas fa-star mr-2 text-blue-primary"></i>IP Terakhir
                        </label>
                        <input type="number" step="0.01" id="ip_semester" name="ip_semester" min="0" max="4"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <label for="khsFoto" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-image mr-2 text-blue-primary"></i>Gambar KHS
                        </label>
                        <p class="text-xs text-gray-500 mb-2">Ukuran maksimum gambar: 500KB</p>
                        <!-- Dropzone -->
                        <div id="dropzone" class="flex flex-col items-center justify-center w-full p-6 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-blue-primary transition" onclick="document.getElementById('khsFoto').click()" ondragover="event.preventDefault(); this.classList.add('border-blue-primary', 'bg-blue-50')" ondragleave="this.classList.remove('border-blue-primary', 'bg-blue-50')" >
                            <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-2"></i>
                            <p class="text-gray-600 text-sm">Klik untuk pilih gambar atau drag & drop di sini</p>
                            <input type="file" id="khsFoto" name="gambar" accept="image/*" class="hidden">
                        </div>
                    </div>
                    <div class="space-y-2">
                    <!-- Live preview -->
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden">
        <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <input type="hidden" id="deletenilaiId" name="id">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">Data Nilai <span id="deleteNilaiName" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/nilai.js'])
