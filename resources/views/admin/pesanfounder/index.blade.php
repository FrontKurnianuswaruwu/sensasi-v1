@section('title', 'Data Pesan Founder')
        ...
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Pesan Founder</span>
                    </li>
            ...
            <div class="flex items-center justify-between gap-4 flex-wrap">
                <div class="relative flex-1 min-w-[250px]">
                    ...
                    <input type="text"
                            ...
                            placeholder="Cari pesan founder...">
                </div>
                <button id="addBtn" class="px-6 py-3 bg-blue-primary text-white rounded-xl hover:bg-blue-light font-medium transition-all duration-300 flex items-center gap-2">
            ...
            <div class="hidden lg:block">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody id="tablePesanFounder" class="bg-white divide-y divide-gray-200">
...
<!-- Modal Tambah/Edit Pesan Founder -->
<div id="pesanFounderModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                            <i id="modalIcon" class="fas fa-envelope text-white text-lg"></i>
                        </div>
                        <h3 id="modalTitle" class="text-xl font-bold text-white">Tambah Pesan Founder Baru</h3>
                    </div>
            ...
            <!-- Body -->
            <form id="pesanFounderForm" class="p-6 space-y-6">
                <input type="hidden" id="pesanFounderId" name="id">

                <div class="space-y-2">
                    <label for="pesanFounderNama" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-user mr-2 text-blue-primary"></i>Nama Founder
                    </label>
                    <input type="text" id="pesanFounderNama" name="pesanFounderNama" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan nama founder">
                </div>

                <div class="space-y-2">
                    <label for="pesanFounderDeskripsi" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-file-alt mr-2 text-blue-primary"></i>Pesan
                    </label>
                    <textarea id="pesanFounderDeskripsi" name="pesanFounderDeskripsi" rows="12" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan pesan founder (Anda bisa menambahkan gambar menggunakan editor)"></textarea>
                </div>
...
<div id="deleteModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <input type="hidden" id="deletepesanFounderId" name="id">
            ...
            <div class="p-6">
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-600">Pesan Founder akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                </div>
...
@vite(['resources/css/user.css','resources/js/admin/pesanfounder.js'])
