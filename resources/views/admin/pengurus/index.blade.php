        ...
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Pengurus</span>
            ...
            <div class="hidden lg:block">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody id="tablePengurus" class="bg-white divide-y divide-gray-200">
...
<div id="pengurusModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="gradient-bg px-6 py-4 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 id="modalTitle" class="text-xl font-bold text-white">Tambah Pengurus Baru</h3>
                    </div>
            ...
            <!-- Body -->
            <form id="pengurusForm" class="p-6 space-y-6">
                <input type="hidden" id="pengurusId" name="id">
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="pengurusNama" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-tag mr-2 text-blue-primary"></i>Nama
                        </label>
                        <input type="text" id="pengurusNama" name="pengurusNama" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan nama">
                    </div>
                    <div class="space-y-2">
                        <label for="pengurusJabatan" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-briefcase mr-2 text-blue-primary"></i>Jabatan Pengurus
                        </label>
                        <input type="text" id="pengurusJabatan" name="pengurusJabatan" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan jabatan">
                    </div>
                </div>
                <div class="space-y-2">
                    <label for="pengurusBiodata" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-id-card mr-2 text-blue-primary"></i>Biodata
                    </label>
                    <input type="text" id="pengurusBiodata" name="pengurusBiodata" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan biodata" >
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <input type="hidden" id="oldFoto" name="oldFoto">
                        <label for="pengurusFoto" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-image mr-2 text-blue-primary"></i>Gambar Pengurus
                        </label>

                        <!-- Dropzone -->
                        <div id="dropzone" class="flex flex-col items-center justify-center w-full p-6 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-blue-primary transition" onclick="document.getElementById('pengurusFoto').click()" ondragover="event.preventDefault(); this.classList.add('border-blue-primary', 'bg-blue-50')" ondragleave="this.classList.remove('border-blue-primary', 'bg-blue-50')" >
                            <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-2"></i>
                            <p class="text-gray-600 text-sm">Klik untuk pilih gambar atau drag & drop di sini</p>
                            <input type="file" id="pengurusFoto" name="gambar" accept="image/*" class="hidden">
                        </div>
                    </div>
                    <div class="space-y-2">
                    <!-- Live preview -->
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden">
        <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <input type="hidden" id="deletepengurusId" name="id">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">Data Pengurus <span id="deletePengurusName" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/pengurus.js'])
