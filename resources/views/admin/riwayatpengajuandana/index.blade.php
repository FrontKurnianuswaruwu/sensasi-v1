        ...
        <div class="floating-search rounded-2xl shadow-lg mb-8 p-6 fade-in" style="animation-delay: 0.1s;">
            <div class="relative">
                ...
                <input type="text"
                        ...
                        placeholder="Cari berdasarkan semester atau nama...">
            </div>
            <div class="mt-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full md:w-auto">
                    <select id="filterTahunAkademikRiwayat"
                        class="w-full sm:w-auto px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-primary/20 focus:border-blue-primary transition-all duration-300 text-sm text-gray-700 bg-white">
                        <option value="">Semua Tahun Akademik</option>
                    </select>
                    <button id="downloadExcelRiwayatBtn"
                        class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-all duration-300 shadow-sm text-sm font-semibold">
