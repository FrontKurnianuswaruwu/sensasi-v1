        ...
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Tahun akademik</span>
                    </li>
            ...
            <div class="hidden lg:block">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody id="tableTahunakademik" class="bg-white divide-gray-200">
...
<!-- Modal Tambah/Edit Tahunakademik -->
<div id="tahunakademikModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-sm max-h-[90vh] overflow-y-auto">
            ...
            <!-- Body -->
            <form id="tahunakademikForm" class="p-6 space-y-6">
                <div class="space-y-2">
                        <input type="hidden" id="tahunakademikId" name="id">
                        <label for="tahunakademikName" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-calendar-days mr-2 text-blue-primary"></i>Tahun akademik
                        </label>
                        <input type="text" 
                                id="tahunakademikName" 
                                name="name"
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden">
        <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <input type="hidden" id="deletetahunakademikId" name="id">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">Data Tahun akademik <span id="deleteTahunakademikName" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/tahunakademik.js'])
@endsection