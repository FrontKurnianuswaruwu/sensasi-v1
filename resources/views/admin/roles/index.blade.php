            ...
            <div class="hidden lg:block">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody id="tableRole" class="bg-white divide-gray-200">
        ...
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form id="roleForm" class="p-6 space-y-6">
                <div class="space-y-2">
                        ...
                        <label for="roleName" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-user-shield mr-2 text-blue-primary"></i>Nama
                        </label>
                        <input type="text" 
                                id="roleName" 
                                name="name"
            ...
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">Data Role <span id="deleteRoleName" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/roles.js'])
@endsection