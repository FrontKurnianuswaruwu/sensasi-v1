...
@section('content')
@section('title', 'Data Pendaftaran PBS')
<!-- Main Content -->
        ...
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Pendaftaran PBS</span>
            ...
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <div class="bg-blue-500 px-6 py-4 rounded-t-2xl">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 class="text-xl font-bold text-white">Konfirmasi Verifikasi</h3>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">
                            ...
                            <span class="font-semibold text-blue-600">memverifikasi</span>
                            <span id="activeUserName" class="font-semibold text-gray-900"></span>
                            dan mengubah statusnya menjadi
        ...
        <div class="modal-overlay absolute inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center p-4">
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
                ...
                <div class="flex border-b border-gray-200 bg-gray-50 overflow-x-auto scrollbar-hide">
                    ...
                    <button data-tab="tab-potensi" class="tab-btn px-6 py-3 text-sm font-semibold transition-all flex items-center space-x-2 border-b-2 border-transparent">
                        <i class="fas fa-brain"></i> <span>Potensi</span>
                    </button>
                </div>
                ...
                <div class="flex-1 overflow-y-auto p-6 space-y-6 bg-white">
                    ...
                    <div id="tab-potensi" class="tab-content hidden">
                        <h4 class="text-blue-primary font-bold mb-4 border-b pb-2 flex items-center">
                            <i class="fas fa-chart-line mr-2"></i> Hasil Tes Potensi Akademik
                        </h4>
                        
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-emerald-50 p-4 rounded-xl border border-emerald-100 transition hover:shadow-md">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-xs text-emerald-600 font-bold uppercase">Benar</span>
                                    <i class="fas fa-check-circle text-emerald-500"></i>
                                </div>
                                <p id="det_potensi_benar" class="text-3xl font-black text-emerald-800">0</p>
                            </div>

                            <div class="bg-rose-50 p-4 rounded-xl border border-rose-100 transition hover:shadow-md">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-xs text-rose-600 font-bold uppercase">Salah</span>
                                    <i class="fas fa-times-circle text-rose-500"></i>
                                </div>
                                <p id="det_potensi_salah" class="text-3xl font-black text-rose-800">0</p>
                            </div>

                            <div class="bg-indigo-50 p-4 rounded-xl border border-indigo-100 transition hover:shadow-md">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-xs text-indigo-600 font-bold uppercase">Kategori</span>
                                    <i class="fas fa-tag text-indigo-500"></i>
                                </div>
                                <p id="det_potensi_status" class="text-sm font-black text-indigo-800 uppercase tracking-wider leading-tight">-</p>
                            </div>

                            <div class="md:col-span-3 flex items-center p-3 bg-gray-50 rounded-lg border border-dashed border-gray-300">
                                <i class="fas fa-calendar-day text-gray-400 mr-3 ml-2"></i>
                                <span class="text-xs text-gray-500 mr-2 font-medium">Tanggal Pelaksanaan:</span>
                                <span id="det_potensi_tanggal" class="text-xs font-bold text-gray-700">-</span>
                            </div>
                        </div>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/pendaftaranpbs.js'])
