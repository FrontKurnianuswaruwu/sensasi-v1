        ...
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Submenu</span>
            ...
            <div class="hidden lg:block">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody id="tableSubmenu" class="bg-white divide-y divide-gray-200">
...
<div id="submenuModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="gradient-bg px-6 py-4 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 id="modalTitle" class="text-xl font-bold text-white">Tambah Submenu Baru</h3>
                    </div>
            ...
            <!-- Body -->
            <form id="submenuForm" class="p-6 space-y-6">
                <input type="hidden" id="submenuId" name="id">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="submenuName" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-tag mr-2 text-blue-primary"></i>Nama Submenu
                        </label>
                        <input type="text" id="submenuName" name="submenuName" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan nama submenu">
                    </div>
                    <div class="space-y-2">
                        <label for="submenuRoute" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-route mr-2 text-blue-primary"></i>Route
                        </label>
                        <input type="text" id="submenuRoute" name="submenuRoute" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan route" >
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="submenuIsparent" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-sitemap mr-2 text-blue-primary"></i>Submenu Type
                        </label>
                        <select id="submenuIsparent" name="submenuIsparent" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900 bg-white">
                            <option value="">Menu Type</option>
                                <option value="1">Master Menu</option>
                            <option value="0">Standalone Menu</option>
                            <option value="2">Action Route</option>
                        </select>
                    </div>
                    <div class="space-y-2">
                        <label for="submenuRole" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-user-shield mr-2 text-blue-primary"></i>Role
                        </label>
                        <select id="submenuRole" name="type" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900 bg-white">
                        </select>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="submenuIcon" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-icons mr-2 text-blue-primary"></i>Icon
                        </label>
                        <input type="text" id="submenuIcon" name="submenuIcon" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan icon">
                    </div> 
                    <div class="space-y-2">
                        <label for="submenuMenuid" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-list-alt mr-2 text-blue-primary"></i>Menu Induk
                        </label>
                        <select id="submenuMenuid" name="submenuMenuid" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900 bg-white">
                        </select>
                    </div>
                </div>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden">
        <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <input type="hidden" id="deletesubmenuId" name="id">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">Data Submenu <span id="deleteSubmenuName" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/submenu.js'])
