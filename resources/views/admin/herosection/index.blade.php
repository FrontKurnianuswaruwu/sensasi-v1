...
@section('content')
@section('title', 'Data Hero section')
<!-- Main Content -->
    ...
    <div class="p-4 lg:p-8">
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Hero section</span>
        ...
        @if (!$isExists)
            <div class="mb-6 flex justify-start fade-in" style="animation-delay: 0.2s;">
                <button id="addSubherosectionBtn" 
                    ...
                    <table class="w-full">
                        <thead class="bg-gradient-to-r gradient-bg to-blue-light text-white">
                            <tr>
                                ...
                                <th class="px-6 py-5 text-left text-sm font-semibold uppercase tracking-wider w-[70%]">
                                    <div class="flex items-center">
                                        Deskripsi
                                    </div>
                                </th>
                        ...
                        <tbody id="tableHerosection" class="bg-white divide-y divide-gray-200">
...
<div id="herosectionModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="gradient-bg px-6 py-4 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 id="modalTitle" class="text-xl font-bold text-white">Tambah Herosection Baru</h3>
                    </div>
            ...
            <!-- Body -->
            <form id="herosectionForm" class="p-6 space-y-6">
                <input type="hidden" id="herosectionId" name="id">
                <div class="space-y-2">
                    <label for="herosectionName" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-tag mr-2 text-blue-primary"></i>Nama Hero section
                    </label>
                    <input type="text" id="herosectionName" name="herosectionName" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan nama herosection">
                </div>
                    
                {{-- Deskripsi --}}
                <div class="space-y-2">
                    <label for="herosectionDescription" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-info-circle mr-2 text-blue-primary"></i>Deskripsi Hero section
                    </label>
                    <textarea id="herosectionDescription" name="herosectionDescription" rows="3" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Masukkan deskripsi herosection"></textarea>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-image mr-2 text-blue-primary"></i>Upload Foto Multiple
                        </label>

                        <!-- Dropzone -->
                        <div id="dropzone"
                            class="flex flex-col items-center justify-center w-full p-6 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-blue-primary transition"
                            onclick="document.getElementById('herosectionFoto').click()">

                            <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-2"></i>
                            <p class="text-gray-600 text-sm">Klik untuk pilih gambar atau drag & drop di sini</p>

                            <input type="file" id="herosectionFoto" name="gambar[]" multiple accept="image/*" class="hidden">
                        </div>
                    </div>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden">
        <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <input type="hidden" id="deleteherosectionId" name="id">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">Data Herosection <span id="deleteHerosectionName" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/herosection.js'])
