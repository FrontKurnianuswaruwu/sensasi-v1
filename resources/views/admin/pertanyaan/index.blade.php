        ...
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Kategori</span>
                    </li>
                    ...
                    <table class="w-full">
                        <thead class="bg-gradient-to-r gradient-bg to-blue-light text-white">
                            <tr>
                                ...
                                <th class="px-6 py-5 text-left text-sm font-semibold uppercase tracking-wider  w-[50%]">
                                    <div class="flex items-center">
                                        Nama
                                    </div>
                                </th>
            ...
            <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">Data Kategori Soal <span id="deleteKategorisoalWaktu" class="font-semibold text-gray-900"></span> akan dihapus secara permanen dan tidak dapat dikembalikan.</p>
                    </div>
...
@vite(['resources/css/user.css','resources/js/admin/pertanyaan.js'])
@endsection