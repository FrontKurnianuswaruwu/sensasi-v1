...
<main class="flex-1 lg:ml-0 overflow-x-hidden">
    <div class="p-4 lg:p-8">
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <a href="{{ route('admin.pertanyaan.index') }}" class="text-blue-600 hover:underline">Data Kategori {{ $namekategori }}</a>
                    </li>
                    <li><span class="mx-2">/</span></li>
                    <li>
                        <span class="text-gray-700">Data Soal</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <input type="hidden" id="kategori_id" name="kategori_id" value="{{ $idkategori }}">
                    ...
                    <table class="w-full">
                        <thead class="bg-gradient-to-r gradient-bg to-blue-light text-white">
                            <tr>
                                ...
                                <th class="px-6 py-5 text-left text-sm font-semibold uppercase tracking-wider  w-[80%]">
                                    <div class="flex items-center">
                                        Nama
                                    </div>
                                </th>
            ...
            <form id="soalForm" class="p-6 space-y-6">
                <div class="space-y-2">
                    ...
                    <label for="pertanyaan" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-calendar-days mr-2 text-blue-primary"></i>Pertanyaan Soal
                    </label>
...
<div id="deleteModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <input type="hidden" id="deletesoalId" name="id">
