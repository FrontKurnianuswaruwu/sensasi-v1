    ...
    <div class="p-4 lg:p-8">
        <div class="mb-8 fade-in flex items-center justify-between">
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-reset flex">
                    <li>
                        <span class="text-gray-700">Data Approval Pengajuan dana</span>
        ...
        <div class="floating-search rounded-2xl shadow-lg mb-8 p-6 fade-in" style="animation-delay: 0.1s;">
            <div class="relative">
                ...
                <input type="text" 
                        id="searchInputapprovalpengajuandana" 
...
<div id="approvalpengajuandanaModal" class="fixed inset-0 z-50 hidden">
    <div class="modal-overlay absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <!-- Body -->
            <form id="approvalpengajuandanaForm" class="p-6 space-y-6">
                <input type="hidden" id="approvalpengajuandanaId" name="id">
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="approvalpengajuandanaSemester" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-tag mr-2 text-blue-primary"></i>Semester
                        </label>
                        <input type="text" id="approvalpengajuandanaSemester" name="approvalpengajuandanaSemester" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Semester" readonly>
                    </div>
                    <div class="space-y-2">
                        <label for="approvalpengajuandanaIpsemester" class="block text-sm font-semibold text-gray-700">
                            <i class="fas fa-briefcase mr-2 text-blue-primary"></i>IP Semester
                        </label>
                        <input type="text" id="approvalpengajuandanaIpsemester" name="approvalpengajuandanaIpsemester" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="IP Semester" readonly>
                    </div>
                </div>
                <div class="space-y-2">
                    <label for="approvalpengajuandanaPengajuandana" class="block text-sm font-semibold text-gray-700">
                        <i class="fas fa-id-card mr-2 text-blue-primary"></i>Pengajuan dana
                    </label>
                    <input type="text" id="approvalpengajuandanaPengajuandana" name="approvalpengajuandanaPengajuandana" class="input-focus w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-primary focus:ring-0 transition-all duration-300 text-gray-900" placeholder="Pengajuan dana" readonly>
                </div>
                <!-- Input Dinamis -->
...
@vite(['resources/css/user.css','resources/js/admin/approvalpengajuandana.js'])
